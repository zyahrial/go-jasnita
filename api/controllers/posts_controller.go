...
import (
	...
	"github.com/zyahrial/go-jasnita/api/auth"
	"github.com/zyahrial/go-jasnita/api/models"
	"github.com/zyahrial/go-jasnita/api/responses"
	"github.com/zyahrial/go-jasnita/api/utils/formaterror"
)
...
// func (server *Server) GetMyPost(w http.ResponseWriter, r *http.Request) {

// 	post := models.Post{}

// 	posts, err := post.FindMyPost(server.DB)
// 	if err != nil {
